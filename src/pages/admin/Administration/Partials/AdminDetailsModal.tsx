...
const ViewAdminDetailsModal: React.FC<ViewAdminDetailsModalProps> = ({
  show,
  onHide,
  admin,
  isLoading = false,
        ...
        >
          <div className="d-flex align-items-center w-100">
            <div className="flex-shrink-0">
              ...
              >
                <i className="fas fas fa-user-gear text-info fs-3"></i>
              </div>
            </div>
            <div className="flex-grow-1 ms-3">
              <Modal.Title className="mb-2">User Details</Modal.Title>
            </div>
          </div>
        </Modal.Header>

        <Modal.Body className="text-center py-5">
          <i className="fas ffas fa-user-gear text-muted mb-3 fs-1"></i>
          <p className="text-muted">No Admin data available</p>
        </Modal.Body>
  ...
  const genderText = getGenderText(admin.gender);
                ...
                <Row className="mb-2">
                  <Col xs={6}>
                    <div>
                      ...
                      <p className="mb-0 fw-semibold">{admin.firstName}</p>
                    </div>
                  </Col>
                  <Col xs={6}>
                    <div>
                      ...
                      <p className="mb-0 fw-semibold">{admin.lastName}</p>
                    </div>
                  </Col>
                </Row>
              ...
              <Card.Body>
                <div className="mb-3">
                  ...
                  >
                    ...
                    <span className="fw-semibold text-info">{admin.email}</span>
                  </a>
                </div>
